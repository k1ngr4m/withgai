...
function cardEffects(classId, cardId, type, cost, idx) {
  ...
  if (cardId === "card_backend_redis_warmup") {
    return [
      { effect_type: "add_cache", target_type: "self", params: { amount: 3 } },
      { effect_type: "apply_status", target_type: "self", params: { status_id: "redis_warmup", amount: 1 } },
    ];
  }
  if (cardId === "card_backend_message_queue") {
    return [
      { effect_type: "apply_status", target_type: "self", params: { status_id: "request_queue", amount: 3 } },
    ];
  }
  ...
  if (cardId === "card_frontend_flex_layout") {
    return [
  ...
  if (cardId === "card_frontend_hotfix_style") {
    return [
      { effect_type: "apply_status", target_type: "self", params: { status_id: "hotfix_style", amount: 1 } },
    ];
  }
  ...
  if (cardId === "card_frontend_first_screen") {
    return [
      { effect_type: "apply_status", target_type: "self", params: { status_id: "first_screen_optimization", amount: 2 } },
    ];
  }
  if (cardId === "card_frontend_vue_suite") {
    return [
      { effect_type: "apply_status", target_type: "self", params: { status_id: "vue_suite", amount: 1 } },
    ];
  }
  ...
  if (cardId === "card_algo_big_o_compress") {
    return [
      { effect_type: "compress_complexity", target_type: "self", params: { amount: 3, compute_per_complexity: 1, block_per_complexity: 2 } },
    ];
  }
  ...
  if (cardId === "card_pm_priority_top") {
    return [
      { effect_type: "set_priority_top", target_type: "selected", params: { amount: 5, clear_other_priority: true } },
      { effect_type: "draw_cards", target_type: "self", params: { amount: 1 } },
    ];
  }
  if (type === "attack") {
...
function relicTriggers(id) {
  const triggers = {
    ...
    relic_pm_meeting_room_claim: ["apply_status"],
...
const relics = [
  ...
  ["relic_pm_meeting_room_claim", "会议室占用权", ["product_manager"], "uncommon", "每回合第一次施加需求变更时额外追加 1 层。", "res://Resources/Art/Generated/P0/icons/relic_icon_meeting_room_claim_v1/prop.png"],
...
const allPlayableClassIds = ["backend", "frontend", "tester", "algorithm", "product_manager"];
const initialBoostIcon = (file) => `res://Resources/Art/Generated/P0/icons/${file}`;
const initialBoosts = [
  {
    id: "boost_perf_points_99",
    name: "绩效预支",
    allowed_classes: allPlayableClassIds,
    weight: 10,
    boost_kind: "effect",
    relic_id: "",
    effects: [{ effect_type: "gain_currency", target_type: "self", params: { amount: 99 } }],
    description: "立刻获得 99 绩效点。",
    art_path: initialBoostIcon("relic_icon_employee_discount_coupon_v1/prop.png"),
    enabled_in_first_playable: true,
  },
  {
    id: "boost_random_cards_2",
    name: "临时灵感",
    allowed_classes: allPlayableClassIds,
    weight: 10,
    boost_kind: "effect",
    relic_id: "",
    effects: [{ effect_type: "add_random_card", target_type: "self", params: { amount: 2 } }],
    description: "获得 2 张随机本职业牌。",
    art_path: initialBoostIcon("node_icon_combat_set_v1/processed/sheet-1.png"),
    enabled_in_first_playable: true,
  },
  {
    id: "boost_random_relic_1",
    name: "办公桌抽屉",
    allowed_classes: allPlayableClassIds,
    weight: 8,
    boost_kind: "effect",
    relic_id: "",
    effects: [{ effect_type: "add_random_relic", target_type: "self", params: { amount: 1 } }],
    description: "获得 1 件随机可用遗物。",
    art_path: initialBoostIcon("relic_icon_cold_brew_bucket_v1/prop.png"),
    enabled_in_first_playable: true,
  },
  {
    id: "boost_opening_draw_1",
    name: "提前看需求",
    allowed_classes: allPlayableClassIds,
    weight: 10,
    boost_kind: "effect",
    relic_id: "",
    effects: [{ effect_type: "add_opening_draw_bonus", target_type: "self", params: { amount: 1 } }],
    description: "每场战斗首回合额外抽 1 张。",
    art_path: initialBoostIcon("relic_icon_design_review_v1/prop.png"),
    enabled_in_first_playable: true,
  },
  {
    id: "boost_opening_block_6",
    name: "先写周报",
    allowed_classes: allPlayableClassIds,
    weight: 10,
    boost_kind: "effect",
    relic_id: "",
    effects: [{ effect_type: "add_opening_block_bonus", target_type: "self", params: { amount: 6 } }],
    description: "每场战斗开局获得 6 防线。",
    art_path: initialBoostIcon("relic_icon_lumbar_cushion_v1/prop.png"),
    enabled_in_first_playable: true,
  },
  {
    id: "boost_max_spirit_8",
    name: "睡满八小时",
    allowed_classes: allPlayableClassIds,
    weight: 8,
    boost_kind: "effect",
    relic_id: "",
    effects: [{ effect_type: "gain_max_spirit", target_type: "self", params: { amount: 8 } }],
    description: "最大精神状态 +8，并治疗 8。",
    art_path: initialBoostIcon("relic_icon_hair_shampoo_v1/prop.png"),
    enabled_in_first_playable: true,
  },
  {
    id: "boost_blue_light_glasses",
    name: "蓝光眼镜",
    allowed_classes: allPlayableClassIds,
    weight: 7,
    boost_kind: "relic",
    relic_id: "relic_blue_light_glasses",
    effects: [],
    description: "获得遗物：蓝光眼镜。",
    art_path: initialBoostIcon("relic_icon_blue_light_glasses_v1/prop.png"),
    enabled_in_first_playable: true,
  },
  {
    id: "boost_employee_coupon",
    name: "员工内购券",
    allowed_classes: allPlayableClassIds,
    weight: 7,
    boost_kind: "relic",
    relic_id: "relic_employee_coupon",
    effects: [],
    description: "获得遗物：员工内购券。",
    art_path: initialBoostIcon("relic_icon_employee_discount_coupon_v1/prop.png"),
    enabled_in_first_playable: true,
  },
];
...
const enemies = [
  ...
  ["enemy_process_specialist", "流程专员", [2], 48, "频繁获得防线与增益", "res://Resources/Art/Generated/P0/icons/enemy_portrait_icon_set_v1/enemy_portrait_final-5.png"],
  ["enemy_performance_inspector", "绩效监察", [2], 52, "惩罚拖回合与手牌膨胀", "res://Resources/Art/Generated/P0/icons/enemy_portrait_icon_set_v1/enemy_portrait_final-6.png"],
  ["enemy_meeting_maniac", "开会狂人", [2], 46, "通过议程召唤衍生物", "res://Resources/Art/Generated/P0/icons/enemy_portrait_icon_set_v1/enemy_portrait_final-7.png"],
  ["enemy_airdrop_director", "空降总监", [3], 58, "切换姿态压迫节奏", "res://Resources/Art/Generated/P0/icons/enemy_portrait_icon_set_v1/enemy_portrait_final-8.png"],
  ["enemy_compliance_judge", "合规审判官", [3], 60, "清除玩家增益并塞入污染", "res://Resources/Art/Generated/P0/icons/enemy_portrait_icon_set_v1/enemy_portrait_final-13.png"],
  ...
  ["elite_outsource_manager", "外包统筹经理", [1, 2], 82, "召唤杂兵并强化协同", "res://Resources/Art/Generated/P0/icons/enemy_portrait_icon_set_v1/enemy_portrait_final-11.png"],
  ["elite_budget_gatekeeper", "预算守门人", [2], 88, "压缩绩效点收益", "res://Resources/Art/Generated/P0/icons/enemy_portrait_icon_set_v1/enemy_portrait_final-12.png"],
  ["elite_approval_eye", "审批流之眼", [3], 96, "冻结高费牌并扭曲顺序", "res://Resources/Art/Generated/P0/icons/enemy_portrait_icon_set_v1/enemy_portrait_final-14.png"],
...
const statusTimingHooks = {
  ...
  redis_warmup: ["round_start"],
  cost_reduction: ["card_cost"],
  request_queue: ["round_end"],
  sharding: ["add_cache"],
  cache: ["deal_damage"],
  ...
  hotfix_style: ["deal_damage", "round_end"],
...
const statusParams = {
  ...
  redis_warmup: {
    cost_reduction_amount: 1,
  },
  request_queue: {
    damage_per_request: 3,
  },
  sharding: {
    extra_cache_amount: 1,
  },
  state_boost: {
...
const config = {
  ...
  initial_boosts: Object.fromEntries(initialBoosts.map((boost) => [boost.id, boost])),
};
...
const lubanJsonTypes = {
  ...
  InitialBoostDef: { allowed_classes: "list,string", effects: "list,EffectSpec" },
...
const tableDefs = [
  ...
  ["InitialBoostDef", Object.values(config.initial_boosts), ["id", "name", "allowed_classes", "weight", "boost_kind", "relic_id", "effects", "description", "art_path", "enabled_in_first_playable"]],
...
const lubanDefines = `<module name="">
  ...
  <bean name="EffectParams">
    ...
    <var name="clear_other_priority" type="bool?"/>
  </bean>
